...
<meta name="keywords"
	content="highcharts, charts, javascript charts, ajax charts, plots, line charts, bar charts, pie charts, javascript plots, ajax plots"
/>
...
#hc-slide {
	background-image:
		url('/joomla/media/mod_highsoft_slider/images/hc-slide.jpg');
}

#hs-slide {
	background-image:
		url('/joomla/media/mod_highsoft_slider/images/hs-slide.jpg');
}

#hm-slide {
	background-image:
		url('/joomla/media/mod_highsoft_slider/images/hm-slide.jpg');
}

#hcc-slide {
	background-image:
		url('/joomla/media/mod_highsoft_slider/images/hcc-slide.jpg');
}
...
.master-video-wrapper {
	...
	position: relative;
	background-image:
		url('/joomla/media/mod_highsoft_slider/images/bg-fallback-optim.jpg');
	background-size: cover;
	background-position: center;
}
...
.demo-box .box-header, .demo-box .box-header>a, .demo-box .box-header>a>i,
	.demo-box .box-content .button-row a {
	color: white;
}
...
@media screen and (min-width: 768px) and (max-width: 992px) {
	...
	.demo-box, #highcharts-demo-box, #highcloud-demo-box, #highmaps-demo-box,
		#highstock-demo-box {
		/*background-color: white;
		color: #777;*/
	...
	#highcharts-demo-box:after, #highstock-demo-box:after,
		#highmaps-demo-box:after, #highcloud-demo-box:after {
		border-radius: 0;
	}
	/*.demo-box .box-header {
		color: #333;
...
#hs-below .box-icon#download-book {
	background-image:
		url('/joomla/media/templates/highsoft_2015/images/1-book.jpg');
	border-radius: 50%;
	opacity: 1;
}
...
#support-icon {
	background-image:
		url('/joomla/media/templates/highsoft_2015/images/support-icon.png');
}

#recruitment-icon {
	background-image:
		url('/joomla/media/templates/highsoft_2015/images/recruitment-icon.png');
}

#download-icon {
	background-image:
		url('/joomla/media/templates/highsoft_2015/images/download-icon.png');
}

#contact-icon {
	background-image:
		url('/joomla/media/templates/highsoft_2015/images/contact-icon.png');
}
...
#hs-bottom a, #hs-bottom .box-header {
	color: #eeeaea;
}

#hs-bottom a:hover, #hs-bottom a:focus, #hs-bottom .tweet-body a:hover,
...
#hs-bottom a.button:hover, #hs-bottom a.button:focus {
	color: #eeeaea;
}
...
#product-list a:focus, #product-list a:hover {
	color: #f7f7f7;
}
...
@media screen and (min-width: 768px) and (max-width: 992px) {
	...
	#hs-bottom .container [class*="col-"]:nth-child(2), #hs-bottom .container [class*="col-"]:last-child
		{
		border-right: 0;
	}
}
...
<body>
					...
					<div id="menu-container">
						<div id="menu-second" class="hidden-xs">
							...
							<ul class="nav navbar-nav">
								...
								<li class="item-261">
									<a href="/plugin-registry">Plugins</a>
								</li>
								<li class="item-262">
									<a href="http://shop.highsoft.com/">Shop</a>
								</li>
							</ul>
							...
							<ul class="nav navbar-nav">
								...
								<li class="item-109 deeper dropdown">
									...
									<ul class="dropdown-menu" role="menu">
										...
										<li class="item-129">
											<a href="/support/roadmap">Roadmap</a>
										</li>
										<li class="item-201">
											<a href="/download">Download</a>
										</li>
										<li class="item-208">
											<a href="http://forum.highcharts.com/">Forum</a>
										</li>
									</ul>
								</li>
								<li class="item-254 deeper dropdown">
									...
									<ul class="dropdown-menu" role="menu">
										<li class="item-255">
											<a href="/products/highcharts">Highcharts</a>
										</li>
										<li class="item-256">
											<a href="/products/highstock">Highstock</a>
										</li>
										<li class="item-257">
											<a href="/products/highmaps">Highmaps</a>
										</li>
										<li class="item-290">
											<a href="https://www.highcharts.com/mobile/">Mobile</a>
										</li>
										<li class="item-258">
											<a href="http://cloud.highcharts.com">Highcharts Cloud</a>
										</li>
										<li class="item-273">
											<a href="/products/highcharts-editor">Highcharts Editor</a>
										</li>
										<li class="item-279">
											<a href="/products/wrappers">Wrappers</a>
										</li>
									</ul>
								</li>
								<li class="item-281">
								...
								<li class="item-282 deeper dropdown">
									...
									<ul class="dropdown-menu" role="menu">
										<li class="item-283">
											<a href="/blog/community/showcase/">Project Showcase</a>
										</li>
										<li class="item-284">
											<a href="/blog/community/charts/">Chart Code Showcase</a>
										</li>
										<li class="item-285">
											<a href="/blog/community/charts/">Contribute</a>
										</li>
									</ul>
								</li>
							</ul>
	...
	<div class="custom">
		<div class="master-video-wrapper">
			<video width="320" height="240" class="master-video" autoplay="autoplay" loop="loop" poster="/">
				<source src="/joomla/media/mod_highsoft_slider/images/video_web_optimised_3mb.mp4" type="video/mp4" />
				<object width="320" height="240" data="/media/editors/tinymce/jscripts/tiny_mce/plugins/media/moxieplayer.swf"
					type="application/x-shockwave-flash"
				>
					<param name="src" value="/media/editors/tinymce/jscripts/tiny_mce/plugins/media/moxieplayer.swf" />
					<param name="flashvars" value="url=/joomla/media/mod_highsoft_slider/images/video_web_optimised_3mb.mp4&amp;poster=/" />
			...
			<div class="master-body col-md-10 col-sm-11 col-xs-12">
				<div class="master-logo">
					<img src="/joomla/media/templates/highsoft_2015/images/logo.svg" border="0" />
				</div>
			...
			<div class="master-arrow" style="opacity: 0.5;">
			...
			<div class="container-fluid">
				...
				<div class="client-logo-list">
					<div id="client-logo-container">
						...
						<div class="clearfix"></div>
						<div>
							<h3 class="block-header secondary">
								... and 72 out of the world's
								<span class="hidden-lg hidden-md hidden-sm">
									<br></br>
								</span>
								</span>
								<a href="http://fortune.com/global500/" target="_blank">100 largest companies</a>
								</p>
						</div>
					</div>
				</div>
		...
		<div class="container">
			<div id="highcharts-demo-box" class="col-md-6 col-sm-12 demo-box">
				<div class="col-xs-12 box-container">
					...
					<div class="box-content">
						<p>
							<strong>Create interactive charts easily for your web projects.</strong>
						</p>
						<p>Used by tens of thousands of developers and 72 out of the world's 100 largest companies, Highcharts is the simplest yet most
							flexible charting API on the market.</p>
						<p class="button-row">
							<a class="hidden-xs" href="/download">
			...
			<div id="highstock-demo-box" class="col-md-6 col-sm-12 demo-box">
				<div class="col-xs-12 box-container">
					...
					<div class="box-content">
						<p>
							<strong>Highstock lets you create stock or general timeline charts in pure JavaScript.</strong>
						</p>
			...
			<div id="highmaps-demo-box" class="col-md-6 col-sm-12 demo-box">
				<div class="col-xs-12 box-container">
					...
					<div class="box-content">
						<p>
							<strong>Interactive map charts with drilldown and touch support.</strong>
						</p>
						<p>Build interactive maps to display sales, election results or any other information linked to geography. Perfect for standalone use
							or in dashboards in combination with Highcharts!</p>
						<p class="button-row">
							<a class="hidden-xs" href="/download">
								<i class="fa fa-cloud-download" aria-hidden="true"></i>
								Download
			...
			<div id="highcloud-demo-box" class="col-md-6 col-sm-12 demo-box">
				<div class="col-xs-12 box-container">
					<div class="demo-frame-container">
						<img src="/images/stories/ipad-hand-banner-600x382-optim.jpg" border="0" alt="Highcharts Cloud" />
					</div>
					<div class="box-header">
						<a href="https://cloud.highcharts.com/">
							Highcharts Cloud
							<i class="fa fa-angle-right"></i>
						</a>
					</div>
					<div class="box-content">
						<p>
							<strong>Online charts for non-techies.</strong>
						</p>
	...
	<div id="first-boxes" class="page-boxes-container">
		<div class="container">
			<div class="col-md-6 col-sm-12">
				<img class="hidden-sm hidden-xs" src="/joomla/media/mod_highsoft_boxes/images/hc-tablet-hands-1024-570-optim.png">
				<img class="hidden-lg hidden-md" style="margin-top: 30px;"
					src="/joomla/media/mod_highsoft_boxes/images/hc-tablet-hands-horizontal-976x569-optim.png"
				>
			</div>
			<div class="col-md-6 col-sm-12">
				<div class="col-xs-12 box-container">
					<div class="box-header">
						<a href="/products/highcharts/#non-commercial">
							Free for non-commercial
							<i class="fa fa-angle-right"></i>
						</a>
					</div>
					<div class="box-content">Do you want to use Highcharts for a personal website, a school site or a non-profit organization? Then you
						don't need our permission, just go on!</div>
				</div>
				<div class="col-xs-6 box-container">
					<div class="box-header">
						<a href="/products/highcharts/#javascript">
							HTML 5
							<i class="fa fa-angle-right"></i>
						</a>
					</div>
				...
				<div class="col-xs-6 box-container">
					<div class="box-header">
						<a href="/products/highcharts/#open">
							Open
							<i class="fa fa-angle-right"></i>
						</a>
					</div>
				...
				<div class="col-xs-12 box-container">
					<div class="box-header">
						<a href="/products/highcharts/#numerous">
							Any chart you'd like
							<i class="fa fa-angle-right"></i>
						</a>
					</div>
					<div class="box-content">Highcharts supports line, spline, area, areaspline, column, bar, pie, scatter, angular gauges, arearange,
						areasplinerange, columnrange and polar chart</div>
				</div>
				<div class="col-xs-6 box-container">
					<div class="box-header">
						<a href="/products/highcharts/#compatible">
							Compatible
							<i class="fa fa-angle-right"></i>
						</a>
					</div>
				...
				<div class="col-xs-6 box-container">
					<div class="box-header">
						<a href="/products/highcharts/#dynamic">
							Dynamic
							<i class="fa fa-angle-right"></i>
						</a>
					</div>
				...
				<div class="container">
					...
					<div id="testimonial-container" class="col-md-12">
						<div class="testimonial-body">
							<p>"I absolutely LOVE Highcharts &amp; maps, very cool! We use it for a web metrics dashboard, which is shared with internal
								marketing stakeholders. The tool is brilliant and the API documentation is super-helpful. I set up some basic, manual reports using
								Highcharts back in August 2014, and since then we make a JSON request to Adobe Analytics and pass the data back to HighCharts. It works
								really well!</p>
						...
						<div class="testimonial-footer">
							...
							<div class="author-logo-container">
								<img src="/joomla/media/mod_highsoft_clients/images/ge-healthcare.png" border="0" />
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 box-container">
					...
					<div class="custom">
						...
						<div class="box-header">
							<a href="http://www.packtpub.com/learning-highcharts-for-javascript-data-visualization/book">
								Get the book
								<i class="fa fa-angle-right"></i>
							</a>
						</div>
						<div class="box purple">
							<div class="box-content">
								<p>
									<strong>Learning Highcharts</strong>
									<br />
									Author Joe Kuan.
									<br />
									Foreword by Highcharts creator Torstein Hønsi.
								</p>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 box-container">
					...
					<div class="custom">
						...
						<div class="box purple">
							<div class="box-content">
								<p>In the Highcharts Forum, you'll find questions and answers, and can discuss anything with the Highcharts developers directly. A
									large community is ready to help you, and our support engineers monitor the forum and attend to unanswered questions on business days.</p>
							</div>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 box-container">
					...
					<div class="custom">
						...
						<div class="box green">
							<div class="box-content">
								<p>
									Do you want to use products for a personal website, a school site or a non-profit organisation? Then you don't need the author's
									permission, just go on and download. For commercial websites and projects, see
									<a href="https://shop.highsoft.com">License and Pricing</a>
									.
								</p>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-md-4 col-sm-5 col-xs-12">
					<div id="news-container">
						<p class="box-header">
							<a href="/component/content/category/2-news/">
								News
								<i class="fa fa-angle-right"></i>
							</a>
						</p>
						<div>
							<a href="/component/content/article/2-news/256-introducing-the-highcharts-node-js-export-server"> Introducing the Highcharts node.js
								export server </a>
							</br>
							<p class="grayed">19-12-2016</p>
						</div>
						</br>
						<div>
							<a href="/component/content/article/2-news/254-easily-create-cross-platform-interactive-charts-with-the-highcharts-net-wrapper">
								Easily create cross-platform interactive charts with the Highcharts .NET wrapper </a>
							</br>
							<p class="grayed">16-12-2016</p>
						</div>
						</br>
						<div>
							<a href="/component/content/article/2-news/247-introducing-offline-pdf-exporting"> Introducing Offline PDF Exporting </a>
							</br>
							<p class="grayed">08-11-2016</p>
						</div>
						</br>
					</div>
					...
					<div class="custom">
						<div id="container">
							...
							<p>
								<strong>Highsoft</strong>
								is the company behind the world's most popular JavaScript charting engine, Highcharts JS, and it's sister products Highstock JS,
								Highmaps JS, and Highcharts Cloud.
							</p>
							<p>Our bootstrapped company is located in Vik i Sogn, Norway, and has 20 employees working full-time on developing, marketing, and
								supporting our products. Additionally, we retain 8 people offshore in various support and custom development roles. We have sold more
								than 45,000 licenses, and our clients include 70 of the 100 largest companies in the world.</p>
						</div>
					</div>
				...
				<div class="col-md-7 col-sm-7 col-xs-12 col-md-offset-1">
					<p class="box-header">
						#Highcharts On
						<i class="fa fa-twitter" style="color: #1dcaff;"></i>
					</h3>
					</p>
					<div id="twitter-quotes">
							...
							<div class="tweet">
								<div class="tweet-body">
									<p style="margin-top: 0;">
										<a href="http://twitter.com/Highcharts">@Highcharts</a>
										Nice video &amp; company. We live in chilean fjords and we are checking your software. Which are the main…
										<a href="https://t.co/meMTR1PO5s">https://t.co/meMTR1PO5s</a>
									</p>
								</div>
								<div class="tweet-footer">
									<a class="grayed" href="http://twitter.com/PLANCTON_ANDINO">
										<strong>PLANCTON ANDINO</strong>
										@PLANCTON_ANDINO
									</a>
									<p class="grayed">05.Aug.2017</p>
								</div>
							</div>
							<div class="tweet">
								<div class="tweet-body">
									<p style="margin-top: 0;">
										<a href="http://twitter.com/SylvainCouet">@SylvainCouet</a>
										<a href="http://twitter.com/Highcharts">@Highcharts</a>
										Merci :)
									</p>
								</div>
								<div class="tweet-footer">
									<a class="grayed" href="http://twitter.com/MusMekh">
										<strong>mustapha mekhatria</strong>
										@MusMekh
									</a>
									<p class="grayed">03.Aug.2017</p>
								</div>
							</div>
						</div>
						<div style="display: none">
							<div class="tweet">
								<div class="tweet-body">
									<p style="margin-top: 0;">
										Créer des
										<a href="http://twitter.com/search?q=%23dataviz">#dataviz</a>
										avec
										<a href="http://twitter.com/Highcharts">@Highcharts</a>
										<a href="https://t.co/Zb3QUvA74k">https://t.co/Zb3QUvA74k</a>
									</p>
								</div>
								<div class="tweet-footer">
									<a class="grayed" href="http://twitter.com/SylvainCouet">
										<strong>Sylvain Couet</strong>
										@SylvainCouet
									</a>
									<p class="grayed">03.Aug.2017</p>
								</div>
							...
							<div class="tweet">
								<div class="tweet-body">
									<p style="margin-top: 0;">
										I say - listen to this guy “You Say Data, I Say System” by
										<a href="http://twitter.com/blprnt">@blprnt</a>
										<a href="https://t.co/jv5VS0ms61">https://t.co/jv5VS0ms61</a>
									</p>
								</div>
								<div class="tweet-footer">
									<a class="grayed" href="http://twitter.com/tomhal99">
										<strong>Tom Gabriel Johansen</strong>
										@tomhal99
									</a>
									<p class="grayed">03.Aug.2017</p>
								</div>
						...
						<div style="display: none">
							<div class="tweet">
								<div class="tweet-body">
									<p style="margin-top: 0;">
										Want to create charts like this one from
										<a href="http://twitter.com/espn">@espn</a>
										? Try
										<a href="http://twitter.com/Highcharts">@Highcharts</a>
										:
										<a href="https://t.co/OY6VXoYtkD">https://t.co/OY6VXoYtkD</a>
										<a href="http://twitter.com/ejcnet">@ejcnet</a>
										<a href="http://twitter.com/search?q=%23ddj">#ddj</a>
										<a href="http://twitter.com/search?q=%23dataviz">#dataviz</a>
										…
										<a href="https://t.co/APKFtLrCnw">https://t.co/APKFtLrCnw</a>
									</p>
								</div>
								<div class="tweet-footer">
									<a class="grayed" href="http://twitter.com/ddjournalism">
										<strong>DataDrivenJournalism</strong>
										@ddjournalism
									</a>
									<p class="grayed">03.Aug.2017</p>
								</div>
							...
							<div class="tweet">
								<div class="tweet-body">
									<p style="margin-top: 0;">
										Kjekt å jobbe med verktøyet til
										<a href="http://twitter.com/Highcharts">@Highcharts</a>
										for å visualisere data.
										<a href="https://t.co/Zh2F1kRVQ7">https://t.co/Zh2F1kRVQ7</a>
									</p>
								</div>
								<div class="tweet-footer">
									<a class="grayed" href="http://twitter.com/7leirdal">
										<strong>Bjørn Leirdal</strong>
										@7leirdal
									</a>
									<p class="grayed">02.Aug.2017</p>
								</div>
							</div>
						</div>
						<div style="display: none">
							<div class="tweet">
								<div class="tweet-body">
									<p style="margin-top: 0;">
										...
										<a href="http://twitter.com/search?q=%23Highcharts">#Highcharts</a>
										<a href="http://twitter.com/search?q=%23StackOverflow">#StackOverflow</a>
										<a href="http://twitter.com/search?q=%23javascript">#javascript</a>
										<a href="https://t.co/ZLJKWzTzrO">https://t.co/ZLJKWzTzrO</a>
										<a href="https://t.co/0d8TBLl1Z2">https://t.co/0d8TBLl1Z2</a>
									</p>
								</div>
								<div class="tweet-footer">
									<a class="grayed" href="http://twitter.com/MusMekh">
							...
							<div class="tweet">
								...
								<div class="tweet-footer">
									<a class="grayed" href="http://twitter.com/jessero24365783">
										<strong>Jesse Rodriguez</strong>
										@jessero24365783
									</a>
									<p class="grayed">30.Jul.2017</p>
								</div>
							</div>
						</div>
						<div style="display: none">
							<div class="tweet">
								<div class="tweet-body">
									<p style="margin-top: 0;">
										Nice article. I did a mind map with your article. I hope you enjoy it.
										<a href="https://t.co/ctK2UmV6A8">https://t.co/ctK2UmV6A8</a>
										<a href="https://t.co/3swsNRCtd4">https://t.co/3swsNRCtd4</a>
									</p>
								</div>
								<div class="tweet-footer">
									<a class="grayed" href="http://twitter.com/ezequiasrocha">
										<strong>Ezequias Rocha</strong>
										@ezequiasrocha
									</a>
									<p class="grayed">29.Jul.2017</p>
								</div>
							</div>
							<div class="tweet">
								<div class="tweet-body">
									<p style="margin-top: 0;">
										<a href="http://twitter.com/Highcharts">@Highcharts</a>
										...and with React!
										<a href="https://t.co/8ldjbQiMuC">https://t.co/8ldjbQiMuC</a>
									</p>
								</div>
								<div class="tweet-footer">
									<a class="grayed" href="http://twitter.com/will_hawker">
										<strong>Will Hawker</strong>
										@will_hawker
									</a>
									<p class="grayed">28.Jul.2017</p>
								</div>
							</div>
						</div>
						<div style="display: none">
							<div class="tweet">
								<div class="tweet-body">
									<p style="margin-top: 0;">
										...
										<a href="http://twitter.com/search?q=%23DataViz">#DataViz</a>
										Tools In 2017
										<a href="https://t.co/YEhndhsiTs">https://t.co/YEhndhsiTs</a>
										<a href="http://twitter.com/tableau">@tableau</a>
										<a href="http://twitter.com/qlik">@qlik</a>
										<a href="http://twitter.com/FusionCharts">@FusionCharts</a>
										<a href="http://twitter.com/Highcharts">@Highcharts</a>
										<a href="http://twitter.com/Datawrapper">@Datawrapper</a>
										<a href="http://twitter.com/sisense">@sisense</a>
									</p>
								</div>
								<div class="tweet-footer">
									<a class="grayed" href="http://twitter.com/bobehayes">
										<strong>Bob E. Hayes</strong>
										@bobehayes
									</a>
									<p class="grayed">28.Jul.2017</p>
								</div>
							...
							<div class="tweet">
								<div class="tweet-body">
									<p style="margin-top: 0;">
										<a href="http://twitter.com/Highcharts">@Highcharts</a>
										This looks cool.. will suss it out when I start with my
										<a href="http://twitter.com/Ionicframework">@Ionicframework</a>
										tutorial
										<a href="https://t.co/AiCmaO0O40">https://t.co/AiCmaO0O40</a>
									</p>
								</div>
								<div class="tweet-footer">
									<a class="grayed" href="http://twitter.com/sliqric">
										<strong>Ricci Rich</strong>
										@sliqric
									</a>
									<p class="grayed">28.Jul.2017</p>
								</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div id="zt-footer-copy">© 2017 Highcharts. All rights reserved.</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="socials">
						<div>
							<a href="https://www.facebook.com/Highcharts" title="Facebook" class="social-icon">
								<i class="fa fa-facebook"></i>
							</a>
							<a href="https://twitter.com/Highcharts" title="Twitter" class="social-icon">
								<i class="fa fa-twitter"></i>
							</a>
							<a href="http://www.linkedin.com/company/highsoft-solutions-as" title="LinkedIn" class="social-icon">
								<i class="fa fa-linkedin"></i>
							</a>
							<a href="https://github.com/highcharts" title="Github" class="social-icon">
								<i class="fa fa-github"></i>
							</a>
							<a href="https://www.youtube.com/channel/UCzxXofPTQ0DoT7uIy3Fxw7A">
